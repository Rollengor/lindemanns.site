...
@section('content')
    <x-admin.container>
        <div id="categories-list" class="d-flex flex-column mx-n3 mx-sm-n4 mt-n4">
...
@push('modals')
    <x-admin.modal.wrapper id="category-create-modal"/>
    <x-admin.modal.wrapper id="category-edit-modal"/>
@endpush
