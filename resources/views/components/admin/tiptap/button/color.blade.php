<div data-tiptap-dropdown class="dropdown-center">
    <button data-tiptap-color-button data-bs-toggle="dropdown" aria-expanded="false" type="button" class="btn btn-sm d-flex btn-outline-secondary p-1">
        <x-admin.icon :name="'palette'" :width="25" :height="25"/>
    </button>
